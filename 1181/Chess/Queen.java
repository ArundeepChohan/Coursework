...
This program is used to create Piece Queen
*/
import java.util.*;
...
public class Queen extends Piece
{
   ...
   /**
      ...
      */    
   public Queen(char team,int x,int y)
   {
      this.team = team;
      row=y;
      col=x;
   ...
   {
      ImageIcon blackQueen = new ImageIcon("image/bQ.png");
      Image im = blackQueen.getImage();
      ImageIcon whiteQueen = new ImageIcon("image/wQ.png");
      Image im2= whiteQueen.getImage();
